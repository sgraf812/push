...
1. [Basics](#basics)
    ...
    - [Readonly](#readonly)
    - [Computed properties](#comp)
2. [The nifty stuff](#nifty)
    - [Recording data dependencies](#record)
    - [Writeproxies](#writeproxy)
3. [Recap for extensiblity](#extend)
...
### Push notifications <a id="notify"/>
...
### Readonly: A writeproxy example <a id="readonly"/>
...
### Introduce a new writeproxy <a id="writeproxy"/>
...
## Recap for extensibility <a id="extend"/>
